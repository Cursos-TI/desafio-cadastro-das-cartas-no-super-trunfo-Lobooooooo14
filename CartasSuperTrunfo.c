...
int main()
{
    ...
    char city_1_code[5];
    char city_1_name[50];
    unsigned long int city_1_population;
    float city_1_area;
    ...
    // winner
    printf(
        "\nVencedor:\nPopulação: %d\nÁrea: %d\nPIB: %d\nPontos Turísticos: %d\nDensidade de População: %d\nPIB por Capita: %d\nSuper poder: %d\n",
        city_1_population > city_2_population,
        city_1_area > city_2_area,
        city_1_GDP_total > city_2_GDP_total,
        city_1_tourist_attractions > city_2_tourist_attractions,
        city_1_population_density<city_2_population_density,
                                  city_1_GDP_per_capita>
            city_2_GDP_per_capita,
        city_1_superpower > city_2_superpower);
